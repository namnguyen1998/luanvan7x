...
<head>
    ...
    <link href="{{asset('public/backend/vendor/mdi-font/css/material-design-iconic-font.min.c')}}ss" rel="stylesheet" media="all">
...
<body class="animsition">
    ...
    <script src="{{asset('public/backend/vendor/bootstrap-4.1/bootstrap.min.j')}}s"></script>
    <!-- Vendor JS       -->
