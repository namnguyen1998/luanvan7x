...
<link rel="stylesheet" href="{{asset('public/backend/dist/plugins/dropify/dropify.min.css')}}">
    <div class="content-wrapper"> 
        ...
        <form action="{{URL::to('/admin-save-danh-muc')}}" class="form-horizontal form-bordered" enctype="multipart/form-data" method="POST" >
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                <input name="nameCategory" placeholder="Tên sản danh mục" class="form-control" type="text">
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <input  type="file" id="input-file-now-custom-1" class="dropify" name="imgCategory" />
                        </div>
